                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse " id="firstNavbar">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"><a class="nav-link" href="a"><i class="fa fa-fw fa-play"></i>EMPEZAR</a></li>
                                ...
                                <li class="nav-item"><a class="nav-link" href="a"><i class="fa fa-fw fa-android"></i>AUTOMATIZAR MI ROBOT</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
